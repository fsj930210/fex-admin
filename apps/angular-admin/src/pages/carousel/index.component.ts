...
@Component({
  selector: 'fex-carousel-page',
  imports: [RouterLink, Card, CarouselControlsComponent],
  templateUrl: './index.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CarouselComponent {
  protected readonly classNames = {
    root: carouselRootClassName,
    viewport: carouselViewportClassName,
    track: carouselTrackClassName(),
  }
  protected readonly slides = ['订单概览', '待办审批', '团队动态']
  protected readonly autoHeightSlides = [
  ...
  protected readonly autoplayCarousel = createCarousel({
    options: { loop: true },
  ...
  constructor() {
    afterNextRender(() => {
      this.basicCarousel.mount(this.basicViewport().nativeElement)
      this.autoplayCarousel.mount(this.autoplayViewport().nativeElement)
      this.autoHeightCarousel.mount(this.autoHeightViewport().nativeElement)
    })
  }
}
