...
export class CheckboxComponent {
  ...
  protected readonly allChecked = computed(() => this.partialValue().length === this.optionValues.length);
  protected readonly partialChecked = computed(() => this.partialValue().length > 0 && !this.allChecked());
