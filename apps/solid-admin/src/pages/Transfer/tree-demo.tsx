...
function Panel(props: { api: TransferPanelApi<Member> }) {
  const data = () =>
    Array.from(new Set(props.api.items.map((i) => i.department))).map((department) => ({
