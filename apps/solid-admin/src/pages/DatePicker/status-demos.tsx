import { FieldDescription, FieldError, FieldLabel, FieldRoot } from '@fex/components-solid/primitive/field'
import { DemoDatePicker, DemoRangePicker, Section } from './shared'

export function StatusDemos() {
  return (
    <Section title="表单状态" description="DatePicker 和 RangePicker 接收外部表单状态，仅负责展示 error / warning 样式。">
