/* oxlint-disable react/no-unstable-nested-components -- The cell renderer is a TanStack callback stabilized by useDataTable. */
...
const editingFeatures = tableFeatures({
...
export function CellEditingDataTableDemo() {
  ...
  const columns: ColumnDef<typeof editingFeatures, Person>[] = (
        ...
        cell: ({ row, getValue }) => {
          ...
          return (
            <Button
              size="sm"
              variant="ghost"
              className="h-auto w-full justify-start px-0 text-inherit"
