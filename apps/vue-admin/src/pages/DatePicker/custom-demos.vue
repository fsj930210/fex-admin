...
import { CalendarCell as CalendarCellView, CalendarGrid, CalendarWeekHeader } from '@fex/components-vue/primitive/calendar'
import { DatePickerContent, DatePickerFooter, DatePickerPanel, DatePickerRoot, DatePickerTrigger } from '@fex/components-vue/primitive/date-picker'
              ...
              <template #default="{ cell }">
                <CalendarCellView :cell="cell" :class="cellClass">
                  <span class="flex flex-col items-center">
                    ...
                    <span v-if="getCalendarValueKey(cell.value) === getCalendarValueKey(releaseDate)" class="text-[10px]">发布</span>
                  </span>
                </CalendarCellView>
              </template>
            </CalendarGrid>
