export const componentRoutes = [
  ...
  { path: '/progress', component: () => import('../../pages/Progress/index.vue') },
  ...
  { path: '/separator', component: () => import('../../pages/Separator/index.vue') },
  ...
  { path: '/tree-select', component: () => import('../../pages/TreeSelect/index.vue') },
  { path: '/toast', component: () => import('../../pages/Toast/index.vue') },
  { path: '/toggle', component: () => import('../../pages/Toggle/index.vue') },
