    ...
    <main className="min-h-screen bg-secondary-background px-page-padding py-space-xl">
      <div className="mx-auto w-full max-w-5xl space-y-space-xl">
        <header className="space-y-space-sm">
          ...
          <p className="text-sm leading-6 text-muted-foreground">临时导航入口，后续后台功能完整后再调整首页结构。</p>
        </header>

        <section className="space-y-space-md">
          <h2 className="text-base font-medium text-foreground">Components</h2>
          <nav className="grid grid-cols-1 gap-space-sm sm:grid-cols-2 lg:grid-cols-3" aria-label="组件示例">
