import { FieldDescription, FieldError, FieldLabel, FieldRoot } from '@fex/components-react/primitive/field'
import { DemoDatePicker, DemoRangePicker, DemoSection } from './shared'

export function StatusDemos() {
  return (
    <DemoSection title="表单状态" description="DatePicker 和 RangePicker 接收外部表单状态，仅负责展示 error / warning 样式。">
      ...
      <FieldRoot hasDescription>
        ...
        <DemoRangePicker status="warning" triggerProps={{ startPlaceholder: '开始日期', endPlaceholder: '结束日期' }} />
