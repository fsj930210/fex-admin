  ...
  return (
    <main className="min-h-screen bg-secondary-background px-page-padding py-space-xl">
      <div className="mx-auto w-full max-w-5xl space-y-space-xl">
        ...
        <Card title="Primitive" description="Media, title, description, and content slots."><Empty><EmptyHeader><EmptyMedia variant="icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M22 12h-6l-2 3h-4l-2-3H2" /><path d="m5.45 5.11-3.27 6A2 2 0 0 0 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6a2 2 0 0 0-.18-.89l-3.27-6A2 2 0 0 0 16.79 4H7.21a2 2 0 0 0-1.76 1.11Z" /></svg></EmptyMedia><EmptyTitle>No approval tasks</EmptyTitle><EmptyDescription>Adjust filters and try again, or create a new workflow record.</EmptyDescription></EmptyHeader><EmptyContent><Badge variant="outline">0 items</Badge></EmptyContent></Empty></Card>
      </div>
    </main>
  )
}
