      ...
      <Transfer
        ...
        renderItem={(member) => (
          <span>
            ...
            <span className="text-muted-foreground">· {member.department as string}</span>
          </span>
        )}
        panels={{
          source: {
            header: (panel) => (
              <>
                ...
                <Badge>{panel.items.length}</Badge>
              </>
            ),
            footer: (
          ...
          target: {
            header: (panel) => (
              <>
                <span className="font-medium text-primary">Delivery team</span>
                <span className="ml-auto text-muted-foreground">{panel.items.length} members</span>
              </>
            ),
            footer: (
              <span className="text-muted-foreground">
