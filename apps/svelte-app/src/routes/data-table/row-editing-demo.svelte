...
<DemoSection title="Row editing" description="Edit row creates one application-owned draft. Save replaces that row in the caller data; Cancel discards the draft without touching the table data."><section class="space-y-space-sm"><h3 class="text-sm font-medium text-foreground">Draft, save and cancel</h3><DataTable {table} {cell} /></section></DemoSection>
