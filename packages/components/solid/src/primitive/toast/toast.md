...
Import from `@fex/components-solid/primitive/toast`. Use `toast.success('Saved successfully')` for quick messages, and mount `ToastViewport` once in the page or app shell.
