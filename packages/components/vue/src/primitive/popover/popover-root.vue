...
const props = withDefaults(defineProps<Omit<FloatingOverlayOptions, 'onOpenChange'> & { defaultOpen?: boolean, trigger?: OverlayTrigger[] }>(), {
  allowedTriggers: () => ['click', 'hover', 'focus', 'context-menu'], arrow: false, closeDelay: 140, defaultOpen: false, dismiss: () => ({ escapeKey: true, outsidePointer: true }), open: undefined, sideOffset: 6, trigger: () => ['click'],
})
