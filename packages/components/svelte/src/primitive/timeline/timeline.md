...
```svelte
<script lang="ts">
  import Timeline from '@fex/components-svelte/primitive/timeline'
  import Item from '@fex/components-svelte/primitive/timeline-item'
  import Indicator from '@fex/components-svelte/primitive/timeline-indicator'
  import Content from '@fex/components-svelte/primitive/timeline-content'
</script>
