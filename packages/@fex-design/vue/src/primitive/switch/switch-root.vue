...
import { switchClassName, type SwitchStyleProps } from '@fex-design/styles/switch'
...
const props = withDefaults(
  ...
  { defaultChecked: false, disabled: false, size: 'default' },
)
...
<template>
  <button
    ...
    @click="handleClick"
  >
    <slot :checked="currentChecked" :state="state" :size="props.size" />
  </button>
</template>
