<script lang="ts">
  import { createHourOptions, getDisplayedHour, getDisplayedPeriod, resolveDisabledTime } from '@fex-design/core/time-picker/options'
...
<TimePickerColumn class={className} {options} selectedValue={selected} {disabled} onselect={value => context.controller.selectHour(value as number, context.use12Hours())} />
