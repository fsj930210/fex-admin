<script lang="ts">
  import { tabsListClassName } from '@fex-design/styles/tabs'; import { cn } from '@fex/utils'; import { getContext, type Snippet } from 'svelte'; import type { HTMLAttributes } from 'svelte/elements'; import { tabsContextKey, type TabsContextValue } from './context'
  interface Props extends Omit<HTMLAttributes<HTMLDivElement>, 'children'> { children?: Snippet, render?: Snippet<[{ props: HTMLAttributes<HTMLDivElement> }]> }
